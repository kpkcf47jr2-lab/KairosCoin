...
const translations = {
  es: {
    ...
    'action.multisend': 'Multi-Envío',
    'action.alerts': 'Alertas',
    'action.audit': 'Auditoría',
    'action.staking': 'Staking',
    'action.vault': 'Vault',
    'action.portfolio': 'Portafolio',
    'action.safe': 'Safe',
    'action.gas': 'Gas',
    'action.bridge': 'Bridge',
    'dashboard.tap_portfolio': 'Toca para ver asignación',
    'dashboard.error_title': 'Error al cargar',
    'dashboard.error_desc': 'No se pudieron obtener los balances',
  ...
  en: {
    ...
    'action.gas': 'Gas',
    'action.bridge': 'Bridge',
    'dashboard.tap_portfolio': 'Tap to view allocation',
    'dashboard.error_title': 'Failed to load',
    'dashboard.error_desc': 'Could not fetch balances',
